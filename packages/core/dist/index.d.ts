...
declare const parseLiveUrl: (liveId: string) => Promise<ParseResult>;
...
declare const initWsConnect: (info: Pick<ParseResult, 'liveRoomId' | 'ttwid'>, events?: WsEents) => Promise<WebSocket>;
...
declare function incoming(data: any, ws: WebSocket, { handleChatMessage, handleCommonTextMessage, handleGiftMessage, handleLikeMessage, handleMatchAgainstScoreMessage, handleMemberMessage, handleRoomUserSeqMessage, handleSocialMessage, handleUpdateFanTicketMessage, handleUnknowMessage, }: Handles): Promise<void>;

declare const root: protobuf.Root;
declare const PushFrame: protobuf.Type;
declare const Response: protobuf.Type;
declare const ChatMessage: protobuf.Type;
declare const CommonTextMessage: protobuf.Type;
declare const RoomUserSeqMessage: protobuf.Type;
declare const SocialMessage: protobuf.Type;
declare const MatchAgainstScoreMessage: protobuf.Type;
declare const MemberMessage: protobuf.Type;
declare const GiftMessage: protobuf.Type;
declare const LikeMessage: protobuf.Type;
declare const UpdateFanTicketMessage: protobuf.Type;

export { ChatMessage, CommonTextMessage, DY, GiftMessage, Handles, LikeMessage, MatchAgainstScoreMessage, MemberMessage, ParseResult, PushFrame, Response, RoomUserSeqMessage, SocialMessage, UpdateFanTicketMessage, WsEents, incoming, initWsConnect, parseLiveUrl, root };
